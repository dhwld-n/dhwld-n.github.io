...
const PROJECTS = {
  ...
  tinker: {
    ...
    overview:
      "친구들이 링크 하나로 바로 쓰는 '심심풀이' 도구를 한 페이지에 모은 웹앱입니다. " +
      "운세방(사주 · 자미두수 · 기문둔갑 · 궁합 · 타로 · 오늘의 운세)에 더해 게임 닉네임 생성기, " +
      "얼굴 사진 피부 분석, '나와 닮은 공룡'(사주 · 얼굴) 등을 담았고 도구를 계속 늘려 가는 중입니다. " +
      "계산과 이미지 처리는 브라우저에서 하고, 텍스트 생성만 Gemini가 스트리밍으로 담당합니다.",
    work: [
      "운세방 — 사주 · 자미두수 · 기문둔갑 · 궁합 · 타로 · 오늘의 운세. 명리 계산(일주 · 명궁 · 오행국 · 오행 분포)은 saju.py · jamidusu.py를 calc.js로 이식해 브라우저에서 돌리고 파이썬 원본과 동일 출력을 검증. 음력 변환 라이브러리 번들.",
      ...
      "디자인 & 홈 — 명식 표가 실제 담은 오행(목화토금수)에 따라 물드는 오방색 시그니처 시스템(frontend-design 방법론). 홈에는 오늘의 잡지식 · 12별자리 순위 · 올해 진행률 · 내 프로필 요약 위젯. 캐시버스트 · no-store 헤더로 모바일 갱신 문제 해결.",
    ],
    stack: [
      "JavaScript (Vanilla)",
      "Vercel Serverless",
